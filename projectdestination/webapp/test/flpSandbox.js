		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comdestinationprojectdestination-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdestinationprojectdestination-display": {
								"semanticObject": "comdestinationprojectdestination",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.destination.projectdestination",
									"url": sap.ui.require.toUrl("com/destination/projectdestination")
								}
							}
						}
					}
