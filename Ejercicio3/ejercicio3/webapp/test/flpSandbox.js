		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ejercicio3",
									"targetURL": "#comejercicio3ejercicio3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comejercicio3ejercicio3-display": {
								"semanticObject": "comejercicio3ejercicio3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ejercicio3.ejercicio3",
									"url": sap.ui.require.toUrl("com/ejercicio3/ejercicio3")
								}
							}
						}
					}
