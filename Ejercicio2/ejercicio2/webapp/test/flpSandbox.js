		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comejercicioejercicio2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comejercicioejercicio2-display": {
								"semanticObject": "comejercicioejercicio2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ejercicio.ejercicio2",
									"url": sap.ui.require.toUrl("com/ejercicio/ejercicio2")
								}
							}
						}
					}
